        # Tgep: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/tgep.git

        ## Objective

        TGEP (Trial-Grade Evidence Platform) provides a structured platform for grading and synthesising trial-level evidence with automated consistency checks and provenance tracking.
        ...
        - Code: https://github.com/mahmood726-cyber/tgep.git
        - Dashboard: https://mahmood726-cyber.github.io/tgep/
